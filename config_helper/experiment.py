...
class Experiment(object):
    ...
    def setup_flash(self):
        ...
        self.conf['flash_config']['n_blocks_per_plane'] = self.para.n_blocks_per_plane
        self.conf['flash_config']['n_planes_per_chip'] = self.para.n_planes_per_chip
        self.conf['flash_config']['n_chips_per_package'] = self.para.n_chips_per_package
        self.conf['flash_config']['n_packages_per_channel'] = self.para.n_packages_per_channel
    ...
    def main(self):
        print 'main in experiment.py'
        self.setup_environment()
        self.setup_fs()
        print 'config before going to setup workload'
        print self.conf
        self.setup_workload()
        print 'config after going to setup workload'
        print self.conf
        self.setup_flash()
        self.setup_ftl()
        self.before_running()
        print 'going to experimetn run now'
        self.run()
        self.after_running()
...
def execute_simulation(para):
    print 'in execute_simulation in experiment'
    """
